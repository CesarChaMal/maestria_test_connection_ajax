...
jscript.dom.prototype.layerCenterH = function(inObj) {
...
jscript.dom.prototype.layerCenterV = function(inObj) {
 ...
 */
jscript.dom.prototype.execScripts = function (inText) {
  var si = 0;
  while (true) {
 ...
 */
jscript.dom.prototype.getDOMElements = function() {
